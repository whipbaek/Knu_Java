...
public class Subway extends PubTrasp {

    public Subway() { //default constructor
        super();
    }

    public Subway(String fare, String section, String payment, String type, int total){
        super(fare,section,payment,type,total);
    }

    public Subway(Subway newSubway){ //copy constructor
        super(newSubway);
    }
    ...
    public String getTypeList() {
        return "(Regular | Priavte | Express)";
    }
    ...
    public String describePubTrasp() {
        return new String(
                "Subway, Basic fare : " + fare + ", Payment method : " + payment + ", "
